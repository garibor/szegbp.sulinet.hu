	...
	<body>
				...
				if(isset($_POST["uploadFile"]) && !empty($_FILES["file"]["name"])){
				    ...
				    if(in_array($fileType, $allowTypes)){
				        ...
				        if(move_uploaded_file($_FILES["file"]["tmp_name"], $targetFilePath)){
				            ...
				            $insertDocument = "INSERT INTO szeg_medias (file_name, type, size, uploaded_on) VALUES ('".$fileName."', '".$fileType."', '".$fileSize."', NOW())";
		...
		?>
			...
			<table id="medias" class="table table-hover medias-table">
			  ...
			  <tbody>
				  <?php 
					$mediaQuery = "SELECT id, file_name, type, size, uploaded_on FROM szeg_medias ORDER BY uploaded_on DESC";
