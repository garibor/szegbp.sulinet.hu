	...
	<body>
		...
		<div class="news-box">
			<div class="actual-news">
				...
				<?php
				$actualNewsQuery = "SELECT id, title, text, date, time, author_id, status, type FROM szeg_news WHERE status != 0 and type = 1 ORDER BY date, time DESC";
					...
					while($actualNewsRow = mysqli_fetch_array($actualNewsResult)){
						?>
							<div class="actual-new-box">
								...
								<div class="actual-new-text"><?php echo($actualNewsRow['text']); ?></div>
			...
			<div class="featured-news-box">
				...
				<?php
					$featuredNewsQuery = "SELECT id, title, text, date, time, author_id, status, type FROM szeg_news WHERE status != 0 and type = 2 ORDER BY date, time DESC";
					...
					while($featuredNewsRow = mysqli_fetch_array($featuredNewsResult)){
						?>
							<div class="featured-news">
								<div class="featured-news-title"><?php echo($featuredNewsRow['title']); ?></div>
								<div class="featured-news-text"><?php echo($featuredNewsRow['text']); ?></div>
							</div>
							<hr/>
						<?php			
					}
		...
		<div class="events-box-body">
			...
			<div class="events-box-text">
				...
				<div class="event-row-2">				
					<div class="event-img"><img src="css/img/vizit%C3%BAra2.jpg"></div>
...
Nagyvonalú segítségüket előre is köszönjük!</div>
		...
		<div class="link-boxs">
			...
			<div class="link-box lb-social" style="border: none;">
				<div class="link-icon" style="margin-left: 20px;"><img src="css/img/icon-facebook.png"><img src="css/img/icon-insta.png" style="margin-left: 20px;"></div>
			</div>
